    ...
    <div class="min-h-screen flex flex-col justify-center items-center bg-[#1a202c] p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl">
            ...
            <div class="bg-[#111827] border-2 border-gray-800 p-8 rounded-3xl shadow-2xl flex flex-col h-full">
                <h3 class="text-white text-xl font-black uppercase mb-2">Starter Plan</h3>
                <div class="flex items-baseline gap-2 mb-6">
                    <span class="text-3xl font-black text-[#ed8936]">₱100</span>
                    <span class="text-gray-500 line-through text-sm">₱60</span>
                ...
                <a href="{{ route('subscription.pay', ['plan' => 'starter']) }}" class="w-full bg-gray-800 hover:bg-[#ed8936] text-white font-bold py-4 rounded-2xl text-center transition-all duration-300">
                    Get Started
                </a>
            </div>
            ...
            <div class="bg-[#111827] border-2 border-[#ed8936] p-8 rounded-3xl shadow-2xl flex flex-col h-full transform scale-105 relative">
                ...
                <h3 class="text-white text-xl font-black uppercase mb-2">Professional Plan</h3>
                <div class="flex items-baseline gap-2 mb-6">
                    <span class="text-3xl font-black text-[#ed8936]">₱500</span>
                    <span class="text-gray-500 line-through text-sm">₱1,000</span>
                    <span class="text-gray-500 text-xs">/ 1 mo</span>
                </div>
                <ul class="text-gray-400 text-sm space-y-4 mb-8 flex-grow">
                ...
                <a href="{{ route('subscription.pay', ['plan' => 'professional']) }}" class="w-full bg-[#ed8936] hover:bg-[#fbd38d] text-[#111827] font-black py-4 rounded-2xl text-center transition-all duration-300 shadow-[0_0_20px_rgba(237,137,54,0.3)]">
                    Subscribe Now
                </a>
            </div>

            <div class="bg-[#111827] border-2 border-gray-800 p-8 rounded-3xl shadow-2xl flex flex-col h-full">
                <h3 class="text-white text-xl font-black uppercase mb-2">Enterprise Plan</h3>
                <div class="flex items-baseline gap-2 mb-6">
                    <span class="text-3xl font-black text-[#ed8936]">₱1,200</span>
                ...
                <a href="{{ route('subscription.pay', ['plan' => 'enterprise']) }}" class="w-full bg-gray-800 hover:bg-[#ed8936] text-white font-bold py-4 rounded-2xl text-center transition-all duration-300">
                    Get Started
                </a>
            </div>
